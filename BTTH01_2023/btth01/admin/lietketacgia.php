                    ...
                    while ($r = mysqli_fetch_assoc($result)){
                        ?>
                         <tr>
                            ...
                            <td><a href="suatacgia.php?sid=<?php echo $r['ma_tgia'];?>" class="btn btn-success">Sửa</a> 
                                <a onclick="return confirm ('bạn có chắc chắn muốn xóa không ?');" href='xoatacgia.php?sid=<?php echo $r['ma_tgia'];?>' class="btn btn-info">Xóa</a></td>
                         </tr>
            <?php
                                }
                        ?>
