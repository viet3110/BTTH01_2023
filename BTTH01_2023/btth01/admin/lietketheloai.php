                    ...
                    while ($r = mysqli_fetch_assoc($result)){
                        ?>
                         <tr>
                            ...
                            <td><a href="suatheloai.php?sid=<?php echo $r['ma_tloai'];?>" class="btn btn-success">Sửa</a> 
                            <a onclick="return confirm ('bạn có chắc chắn muốn xóa không ?');" href='xoatheloai.php?sid=<?php echo $r['ma_tloai'];?>' class="btn btn-info">Xóa</a></td>
                         </tr>
            <?php
                                }
                        ?>
