...
//cau lenh xoa sql
$edit_sql = " SELECT * FROM tacgia WHERE ma_tgia=$id "; 
    ...
    <h3 class="text-center text-uppercase fw-bold">Thêm mới tác giả</h3>
        <form method="POST" action="update.php">
            ...
            <div class="form-group">
                ...
                <input id = "ten_tgia"name = "ten_tgia" class="form-control" placeholder="VD:nguyen van a" value ="<?php echo $row['ten_tgia']?>">
            </div>

            <div class="form-group">
                <label for="ma_tgia">Mã tác giả</label>
                <input name = "ma_tgia" id="ma_tgia" class="form-control" placeholder="VD: 123 "  value ="<?php echo $row['ma_tgia']?>">
            </div>
            <button type="submit" href="lietketacgia.php" class="btn btn-success" name = "add">Sửa</button>
        </form>
</div>
