...
<body>
    ...
    if(isset($_POST['add'])){
        ...
        // $f =$_POST['ngayviet'];
        if($conn -> query("INSERT INTO baiviet (ma_bviet, tieude,ten_bhat,ma_tloai,tomtat,ma_tgia,) VALUES ('$ma_bviet','$tieude','$ten_bhat','$ma_tloai','$tomtat','$ma_tgia') ")){
    ...
    <h1>Thêm bài viết</h1>
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input name = "ma_bviet" class="form-control" >
            </div>
            ...
            <div class="form-group">
                ...
                <input name = "ma_tgia" class="form-control"  >
            </div>
